...
## PS
很明显，我的笔记本噶了，所以我失去了我的源码和维护整个项目的信心，同时我也不知道如何宣传这个项目，本质上是鹿管的时候为了合理的，有节制的鲁，所以想要记录时间，比如一周一次或者三天一次，但鲁完其实很麻烦，如果要记录每一次的日期时间还需要计算间隔，所以才有了这个快乐鹿，如果你看到这段话，并且也使用了这个软件，并且觉得很不错，那很感谢你的赏识和使用，也欢迎提交issues告诉我，说不定我就会有了重新继续维护这个项目的信心。（我自己用起来感觉还是满爽的）
